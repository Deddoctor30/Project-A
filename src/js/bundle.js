...
var bgSwitcher = function bgSwitcher() {
  var switcher = document.querySelectorAll('.switcher__input');
...
/* harmony export */ });
function burger() {
  var content = document.querySelector('.burger__content'),
...
var competition = function competition() {
  var tableBody = document.querySelector('.calendar__body');
  var monthName = document.querySelector('.calendar__month');
  var yearName = document.querySelector('.calendar__year');
  var arrPrev = document.querySelector('#prevArr');
  var arrNext = document.querySelector('#nextArr');
  var date = new Date();
  ...
  arrowPrev();
  var createNet = function createNet(year, month) {
    var a = 0;
    for (var i = 0; i < 6; i++) {
      var newRow = document.createElement('tr');
      newRow.classList.add("tableRow-".concat(i));
...
var popup = function popup() {
  ...
  var trigger = document.querySelector('#singIn');
...
/* harmony import */ var swiper_swiper_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/css */ "./node_modules/swiper/swiper.min.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_sass_loader_dist_cjs_js_navigation_min_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);
       ...
       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_sass_loader_dist_cjs_js_navigation_min_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _css_loader_dist_cjs_js_sass_loader_dist_cjs_js_navigation_min_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _css_loader_dist_cjs_js_sass_loader_dist_cjs_js_navigation_min_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
